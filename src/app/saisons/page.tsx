  ...
  return (
    <>
      <PageHeader
        eyebrow="Historique"
        title="Saisons"
        description="Progression de Projet X saison après saison, en club et en élo individuel."
      />
        ...
        <div className="rounded-2xl border border-primary/40 bg-primary/10 p-6">
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-border bg-surface-2 px-4 py-3">
              ...
              <div>
                <p className="text-xs text-muted">Meilleure progression</p>
              ...
              {history.map((s) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 text-sm font-medium text-foreground/90">
                    <TrendingUp size={16} className="text-primary-2" />
                    {s.topPlayer}
